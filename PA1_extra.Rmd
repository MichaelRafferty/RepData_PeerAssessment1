...
By adding several identical values to the exact center of the graph, the mean did not change, but the days the previously had all NA now occupied the center of the chart creating a new median.
